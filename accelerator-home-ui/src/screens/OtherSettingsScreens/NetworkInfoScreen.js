...
export default class NetworkInfo extends Lightning.Component {
    ...
    _active() {
        this.onInterfaceStatusChangeCB = NetworkManager.thunder.on(NetworkManager.callsign,'onInterfaceStateChange', data => {
            this.WARN("Oninterfacestatuschange" + JSON.stringify(data))
            this.refreshDetails();
        })
