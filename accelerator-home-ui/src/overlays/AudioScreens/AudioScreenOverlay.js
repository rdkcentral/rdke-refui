    ...
    return [
      ...
      class DynamicRange extends this{
        ...
        _handleEnter() {
          ...
          this.appApi.setVolumeLevel(((GLOBALS.deviceType == "IpTv") ? "SPEAKER0" : "HDMI0"), 100).then(() => {
          ...
          this.appApi.getEnableAudioPort(((GLOBALS.deviceType == "IpTv") ? "SPEAKER0" : "HDMI0")).then(() => {
          }).catch(err => {
            console.log(err)
          })
          ...
          this.appApi.setEnableAudioPort(((GLOBALS.deviceType == "IpTv") ? "SPEAKER0" : "HDMI0")).then(() => {
