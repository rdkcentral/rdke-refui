...
class RDKShellApis {
  ...
  enableVirtualDisplay = (client, enable = true, callsign) => this.thunderCall('enableVirtualDisplay', 'enableVirtualDisplay', { client, enable, callsign: callsign !== undefined ? callsign : client });
  ...
  setHolePunch = (client, holePunch = true, callsign) => this.thunderCall('setHolePunch', 'setHolePunch', { client, holePunch, callsign: callsign !== undefined ? callsign : client });
