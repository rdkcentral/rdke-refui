...
export default class Network {
  ...
  getIPSettings(interfaceName = "ETHERNET") {
    return new Promise((resolve, reject) => {
  ...
  startConnectivityMonitoring(intervalInSec = 30) {
	return new Promise((resolve, reject) => {
	  this.LOG(this.callsign + "startConnectivityMonitoring with interval "+ intervalInSec);
  ...
  setDefaultInterface(interfaceName = "ETHERNET", persist = true) {
	return new Promise((resolve, reject) => {
	  this.INFO(this.callsign + "setDefaultInterface with interface: " + interfaceName + " persist: "+ persist);
  ...
  setInterfaceEnabled(interfaceName, enabled = true, persist = true) {
	return new Promise((resolve, reject) => {
		this.INFO(this.callsign + " setInterfaceEnabled interface:" + interfaceName + " enabled:" + enabled + " persist:" + persist);
